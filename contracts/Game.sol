...
contract MyEpicGame is ERC721 {
    ...
    constructor(
        ...
        uint256[] memory characterCriticalMultiplier,
        ...
        for (uint256 i = 0; i < characterNames.length; i += 1) {
            defaultCharacters.push(
                CharacterAttributes({
                    ...
                    criticalMultiplier: characterCriticalMultiplier[i]
                })
            );
    ...
    function mintCharacterNFT(uint256 _characterIndex) external {
        ...
        nftHolderAttributes[newItemId] = CharacterAttributes({
            ...
            criticalMultiplier: defaultCharacters[_characterIndex]
                .criticalMultiplier
        });
        ...
        returns (string memory)
    {
        ...
        string memory strCriticalMultiplier = Strings.toString(
            charAttributes.criticalMultiplier
        );
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '", "description": "This is an NFT that lets people play in the game BattleCats!", "image": "ipfs://',
                        ...
                        strCriticalChance,
                        '}, { "trait_type": "Critical Multiplier", "value": ',
                        strCriticalMultiplier,
    ...
    function attackBoss() public {
        ...
        require(player.hp > 0, "Error: dead cats cant attack! ... yet ;)");
